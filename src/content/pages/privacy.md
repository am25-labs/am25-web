...
This website is managed by AM25, S.A.S. de C.V. For questions or inquiries, please contact via [email](mailto:hola@alemartir.com).
...
This site may contain links to external platforms such as social media or streaming services (e.g., Spotify). By accessing these links, you leave this website and become subject to the privacy policies of those platforms. AM25 has no control over their data processing practices.

## User rights

This website does not actively collect personal data through tracking systems or user accounts.

If you submit information voluntarily (e.g., via contact forms), you may request:

- Access to your data
- Deletion of your data
- Limitation or objection to processing

To exercise these rights, please contact via [email](mailto:hola@alemartir.com).
